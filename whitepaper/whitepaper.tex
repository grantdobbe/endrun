...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \item \textbf{\textsc{Chain of Custody}} - An array detailing the transmission path of the payload. See Section~\ref{subsec:chainofcustody} for more details.
    \item \textbf{\textsc{Copies}} - The number of copies of a message that should be transmitted by nodes.
